...
async function save_session (args) {
  ...
  return await createNewSession(creationTime, commonName, chosen_notary.name, cleartext, pgsg, false);
...
async function verifyPgsgV4 (json) {
  ...
  var cleartext = await tlsn.decrypt_tls_responseV4(encRecords, server_write_key, server_write_IV)
